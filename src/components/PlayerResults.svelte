...
<style>
    .match-row {
        display: grid;
        grid-template-columns: 2fr 80px 2fr 100px 100px;
        padding: 10px;
...
<div>
    ...
    {#each matchHistory.reverse() as match, index}
        ...
        <div class="match-row">
            ...
            <div class="match-cell match-result" style="--color-left: {getResultColor(match.score, match.opponent_score)[0]}; --color-right: {getResultColor(match.score, match.opponent_score)[1]}">
